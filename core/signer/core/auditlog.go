...
func (l *AuditLogger) SignData(ctx context.Context, contentType string, addr common.MixedcaseAddress, data interface{}) (common.Bytes, error) {
...
func (l *AuditLogger) SignTypedData(ctx context.Context, addr common.MixedcaseAddress, data TypedData) (common.Bytes, error) {
...
func (l *AuditLogger) EcRecover(ctx context.Context, data common.Bytes, sig common.Bytes) (common.Address, error) {
